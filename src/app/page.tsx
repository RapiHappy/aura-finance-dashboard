...
export default function ReviewCashLanding() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16 relative z-10">
          <div className="flex-1">
            ...
            <p className="text-[#A1A1AA] text-lg mb-8">
              ReviewCash connects you with over 150,000 active users ready to test your product, leave reviews, and join your communities. Powered by our proprietary Anti-Fraud AI.
            </p>
      ...
      <footer className="w-full py-12 border-t border-white/10 bg-[#050505] relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-tight text-white">ReviewCash</span>
          </div>
          ...
          <p className="text-[10px] text-zinc-600 font-mono uppercase tracking-widest">
            &copy; {new Date().getFullYear()} ReviewCash. All rights reserved.
          </p>
        </div>
      </footer>
